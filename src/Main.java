...
public class Main {
    ...
    public static void testPerson() {
        Person p1 = new Person("Wednesday", "Addams", 5);
        Person p2 = new Person("", "Srichon", -1);
        Person p3 = new Person("Pattaradanai", null, -1);
        Person p4 = new Person("Eric", "Summer");
    ...
    public static void testDepartment() {
        ...
        Department d1 = new Department("KMUTT");
        Department d2 = new Department(""); // Default Type
        Department d3 = new Department(null); // Default Type
        ...
        for (int i = 0; i < 10; i++) {
            ...
            d1.addStaff("Suzy", "Stand", rand);
        }

        System.out.println(Arrays.toString(d1.getAllCode()));
        System.out.println(d1.getStaff(62)); // Return the person who have that code
        System.out.println(d1.getStaff(1)); // If there are no one with the code
        System.out.println(Arrays.toString(d1.getAllType())); // Return an array with no duplicated
    }
}
/*
